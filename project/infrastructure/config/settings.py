...
class Settings(BaseSettings):
    ...
    fast_search_context_top_k: int = Field(default=8, alias="FAST_SEARCH_CONTEXT_TOP_K")
    fast_search_clarifying_queries_limit: int = Field(default=3, alias="FAST_SEARCH_CLARIFYING_QUERIES_LIMIT")
    fast_search_extra_retrieval_top_k: int = Field(default=5, alias="FAST_SEARCH_EXTRA_RETRIEVAL_TOP_K")
    ...
    deep_search_rule_queries_limit: int = Field(default=5, alias="DEEP_SEARCH_RULE_QUERIES_LIMIT")
    deep_search_entity_queries_limit: int = Field(default=5, alias="DEEP_SEARCH_ENTITY_QUERIES_LIMIT")
    deep_search_rule_top_k: int = Field(default=6, alias="DEEP_SEARCH_RULE_TOP_K")
    deep_search_entity_top_k: int = Field(default=3, alias="DEEP_SEARCH_ENTITY_TOP_K")
    deep_search_scope_context_top_k: int = Field(default=5, alias="DEEP_SEARCH_SCOPE_CONTEXT_TOP_K")
    deep_search_extra_queries_limit: int = Field(default=3, alias="DEEP_SEARCH_EXTRA_QUERIES_LIMIT")
    deep_search_extra_top_k: int = Field(default=5, alias="DEEP_SEARCH_EXTRA_TOP_K")
    deep_search_rerank_top_k: int = Field(default=8, alias="DEEP_SEARCH_RERANK_TOP_K")
